...
let new_Guest = "Jdc";
let indexOfabsent_Guest = Guest_list.indexOf(absent_Guest);
...
let newGuestInStart = "Sir khan";
Guest_list.unshift(newGuestInStart);
//console.log(Guest_list)
let newGuestInMid = "Sir Maliq";
let midIndex = Math.floor(Guest_list.length / 2);
Guest_list.splice(midIndex, 0, newGuestInMid);
//Console.log(Guest_list)
let newGuestAtEnd = "Sir Jutt";
